    ...
    <div>
      ...
      <div className="border-l-3 text-xs md:text-sm mx-10 min-[400px]:text-md text-sm text-[#24282e] rounded-r-3xl border-[#3F0091] pl-5 mt-10 tracking-wide leading-10 font-[400]">
        <p>
          ...
          18-year-old
          <span className="text-[#3F0091]"> MERN Stack Developer</span> from
          <span className="text-[#3F0091]"> Karachi, Pakistan</span>. I've been
          coding for <span className="text-[#3F0091]">1.5 years</span>. What
          started as curiosity became a passion. I specialize in
          <span className="text-[#3F0091]">
            {" "}
            React, Node.js, Express, and MongoDB
          </span>
          , and I'm currently exploring
          <span className="text-[#3F0091]"> TypeScript and Next.js</span>.
          Before coding, I spent{" "}
          <span className="text-[#3F0091]">1 year as a graphic designer</span> —
          using
          <span className="text-[#3F0091]"> Illustrator and Photoshop</span> to
          create logos, posters, and brand identities. That experience taught me
          how
          <span className="text-[#3F0091]"> design and development</span> work
          together to create user-friendly experiences. I've built{" "}
          <span className="text-[#3F0091]">5+ projects</span>, including a
          <span className="text-[#3F0091]">
            {" "}
            full-stack e-commerce platform
          </span>
          , a portfolio website, a weather app, and a task manager — with
          <span className="text-[#3F0091]"> 3 live and deployed</span>. Each
          ...
          <span className="text-[#3F0091]"> real-world problems</span> and build
      ...
      <div className="mx-10   gap-2 flex flex-col rounded-xl  p-2 py-5 max-w-130">
        <h1 className="flex text-xl sm:text-3xl font-bold">
          Send <span className="text-[#3F0091] pl-1"> Email</span>
        </h1>
        <form onSubmit={(e) => {emailSender(e)}}>
          <div className="flex gap-4 pb-2 w-full">
            <label className="flex flex-col gap-2 flex-1">
              <p className="text-xs  sm:text-sm font-semibold text-[#4e525a]">
                Name <span className="text-[#3F0091]">*</span>
              </p>
              <input
                value={name}
          ...
          <label className="flex flex-col gap-2">
            <p className="text-xs sm:text-sm font-semibold text-[#4e525a]">
              Subject <span className="text-[#3F0091]">*</span>
            </p>
            <input
              value={subject}
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
          ...
          <div className="pt-2">
            <label className="flex flex-col gap-2">
              <p className="text-xs sm:text-sm font-semibold text-[#4e525a]">
                Message <span className="text-[#3F0091]">*</span>
              </p>
              <textarea
                value={message}
